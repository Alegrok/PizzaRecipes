...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pizzaItemList.add(new PizzaItem(
                R.drawable.marghuerita,
        ...
        mRecyclerView = findViewById(R.id.pizza_recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mAdapter = new Adapter(pizzaItemList, this);
